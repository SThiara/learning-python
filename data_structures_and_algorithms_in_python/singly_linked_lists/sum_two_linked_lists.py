...
class LinkedList:
    ...
    def sum_two_lists(self, llist):
        ...
        while list1 and list2:
            sum = list1.data + list2.data + carryover
            carryover = 0
            if sum >= 10:
                sum = sum % 10
                carryover = 1
            summed_lists.append(sum)
            list1 = list1.next
            list2 = list2.next
        
        if list1:
            sum = list1.data + carryover
            summed_lists.append(sum)
            list1 = list1.next

        if list2:
            sum = list2.data + carryover
            summed_lists.append(sum)
            list2 = list2.next
        
        while list1:
            summed_lists.append(list1.data)
            list1 = list1.next
        
        while list2:
            summed_lists.append(list2.data)
            list2 = list2.next

        summed_lists.print_list()
